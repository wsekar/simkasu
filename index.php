...
<body class="app sidebar-mini">
    ...
    <main class="app-content">
        ...
        ?>
        <?php
        $jumlah_temp_before = mysqli_query($koneksi,"select temp_before from temperature");
        $hasil1= mysqli_num_rows($jumlah_temp_before);

        $jumlah_temp_after = mysqli_query($koneksi,"select temp_after from temperature");
