...
<head>
    ...
    <title>Halaman Tambah Kadar Air Minum | Simkasu</title>
    <meta charset="utf-8">
...
<body class="app sidebar-mini">
	...
	<div class="container" style="margin-top:20px">
		...
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "INSERT INTO ph VALUES('','$id_kandang','$ph_before', '$ph_after', '$waktu_perbaikan')") or die(mysqli_error($koneksi));
			if($sql){
				echo '<script>alert("Berhasil menambahkan data."); document.location="kadar_air_minum.php";</script>';
			}else{
        ...
        <div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="id_kandang" class="form-control" size="4" required>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Ph Before</label>
				<div class="col-sm-10">
					<input type="text" name="ph_before" class="form-control" size="4" required>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Ph After</label>
				<div class="col-sm-10">
					<input type="text" name="ph_after" class="form-control" required>
				</div>
			</div>
            <div class="form-group row">
				<label class="col-sm-2 col-form-label">Waktu Perbaikan</label>
				<div class="col-sm-10"> <!-- Date input -->
                    <input class="form-control" id="date" name="waktu_perbaikan" type="datetime-local"/>
                </div>
			</div>
			<div class="form-group row">
