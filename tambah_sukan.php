...
<head>
    ...
    <title>Halaman Tambah Suhu Kandang | Simkasu</title>
    <meta charset="utf-8">
...
<body class="app sidebar-mini">
	...
	<div class="container" style="margin-top:20px">
		<h2>Tambah Temperature Suhu Kandang</h2>	
		<hr>	
		<?php
		if(isset($_POST['submit'])){
			...
			$sql = mysqli_query($koneksi, "INSERT INTO temperature VALUES('','$id_kandang','$temp_before', '$temp_after', '$waktu_perbaikan')") or die(mysqli_error($koneksi));
			if($sql){
				echo '<script>alert("Berhasil menambahkan data."); document.location="suhu_kandang.php";</script>';
			}else{
		...
		<form action="" method="post">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Temperatur Before</label>
				<div class="col-sm-10">
					<input type="text" name="temp_before" class="form-control" size="4" required>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Temperatur After</label>
				<div class="col-sm-10">
					<input type="text" name="temp_after" class="form-control" required>
				</div>
			</div>
            <div class="form-group row">
